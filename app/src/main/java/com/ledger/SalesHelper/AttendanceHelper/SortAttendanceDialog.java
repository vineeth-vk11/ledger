...
public class SortAttendanceDialog extends AppCompatDialogFragment implements DatePickerDialog.OnDateSetListener{
    ...
    public SortAttendanceDialog(String existingStart, String existingEnd) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        if(existingStart!=null && existingEnd!=null){
            ...
            if(existingStart.equals("") && existingEnd.equals("")){
    ...
    public void onAttach(@NonNull Context context) {
        ...
        onDatesSelected = (OnDatesSelected) context;
